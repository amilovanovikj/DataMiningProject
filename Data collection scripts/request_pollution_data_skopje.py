...
counter = 0
import time
url = 'https://skopje.pulse.eco/rest/dataRaw'
...
# lisice = 1001; miladinovci = 1002; karpos = 1003; gazi_baba = 1004; centar = 1005
locations = { 'lisice':1001, 'miladinovci':1002, 'karpos':1003, 'gazi_baba':1004, 'centar':1005}
...
for pollutant in pollutants:
    ...
    for loc, id in locations.items():
        ...
        with open('{}_{}.csv'.format(pollutant, loc),'w') as file:
            file.write('sensorId')
            file.write('\t')
            file.write('stamp')
            file.write('\t')
        ...
        while True:
            ...
            if response.status_code == 200:
                ...
                with open('{}_{}.csv'.format(pollutant, loc),'a') as file:
            ...
            print(pollutant + ", " + loc + ": " + date_from_string)
